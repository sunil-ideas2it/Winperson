...
angular.module('WinpersonApp').controller('AnswerController', ['$scope', '$http', '$routeParams', '$rootScope', function($scope, $http, $routeParams, $rootScope) {
    ...
    $scope.showJob = function() {
           $scope.gridOptions = { data: 'jobs',
            columnDefs: [{field:'id', displayName:'Job Id'},
    ...
    $scope.showAnswer = function() {
        $scope.gridOptions = { data: 'answers',
            columnDefs: [{field:'question', displayName:'Question'},
                         { displayName: 'Video', cellTemplate:
                         '<div class="grid-action-cell">'+
                         '<a href="#/showVideo/{{ row.getProperty(\'videoFileName\')}}" target="_blank">Click Here</a></div>'}
                        ]};
      ...
      $scope.showApplicant = function() {
       $scope.gridOptions = { data: 'invites',
            columnDefs: [{field:'jobid', displayName:'Job Id'},
                         {field:'firstname', displayName:'Applicant Name'},
                         {field:'emailid',displayName:'Email'},
                          {field:'status',displayName:'Status'},
                         { displayName: 'Details', cellTemplate:
                         '<div class="grid-action-cell">'+
                         '<a href="#/showanswer/{{row.getProperty(\'jobid\')}}/{{row.getProperty(\'applicantId\')}}">Click Here</a></div>'}
                        ]};
